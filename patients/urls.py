...
urlpatterns = [
    ...
    url(regex=r'^measurements$',view=views.MeasurementListView.as_view(),name='listMeasurements', ),
    url(regex=r'^measurement~update/$',view=views.MeasurementUpdateView.as_view(),name='updateMeasurement'),
